...
export const MASTER_BREEDER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_MAINNET]: '0x6efC5CdF43c6e9BbDbF807C95246D885484120e5',
...
export const PIT_BREEDER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_MAINNET]: '0x87a818dc56923CF38Ba4388F01828B7C6f29345c',
...
export const PIT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.AURORA_MAINNET]: new Token(
    ChainId.AURORA_MAINNET,
    '0xff6f9e02c4c5FD956ad923cB2E6252F5a1BF0A8F',
    18,
    'xIZA',
    'Staked IZA'
  ),
